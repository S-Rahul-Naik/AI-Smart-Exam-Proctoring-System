...
const navItems = [
  { path: '/admin/monitoring', icon: 'ri-live-line', label: 'Live Monitoring', badge: '8' },
  ...
  { path: '/admin/analytics', icon: 'ri-bar-chart-2-line', label: 'Reports & Analytics' },
  { path: '/admin/notifications', icon: 'ri-mail-send-line', label: 'Notifications' },
  { path: '/admin/ai-engine', icon: 'ri-cpu-line', label: 'AI Engine' },
      ...
      <div className="p-4 border-t border-[#1e2330]">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-[#1a1d24]">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-white text-xs font-semibold truncate">Dr. Sarah Mitchell</div>
